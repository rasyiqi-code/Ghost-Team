...
// ── hoisted mocks ──────────────────────────────────────────────
const { mockFindMany, mockFindFirst, mockInsertChain, mockUpdateChain, mockTestConnection, mockMigratePlatformUserId, } = vi.hoisted(() => {
    ...
    return {
        ...
        mockMigratePlatformUserId: vi.fn(),
    };
});
// ── module-level mocks ─────────────────────────────────────────
