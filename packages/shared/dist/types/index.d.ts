...
import type { registerSchema, loginSchema, userResponseSchema, tokenResponseSchema, messageCreateSchema, messageResponseSchema, messageListResponseSchema, fileResponseSchema, fileSearchSchema, voiceProcessResponseSchema, voiceStatusResponseSchema, platformConnectionCreateSchema, platformConnectionResponseSchema, memorySearchSchema, memorySearchResultSchema, memorySearchResponseSchema, reportResponseSchema, reportGenerateResponseSchema, aiProviderCreateSchema, aiProviderResponseSchema, aiProviderUpdateSchema, systemSettingItemSchema, envSettingResponseSchema } from '../schemas/index.js';
